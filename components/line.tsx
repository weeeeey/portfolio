...
export const Line = () => {
    return (
        <div className="w-[1px] h-[550%] bg-violet-500 absolute top-[300px] left-[250px] z-10  ">
            ...
            <div className="absolute top-[2500px] -left-[5px] w-3 h-5 rounded-full bg-white" />
            <div className="absolute w-2 h-2 bg-white  bottom-[1000px] -left-[3.5px] rounded-full" />
            <div className="absolute bottom-[1100px] -left-[5px] w-3 h-5 rounded-full bg-white" />
            <div className="absolute w-2 h-2 bg-white  bottom-[600px] -left-[3.5px] rounded-full" />
